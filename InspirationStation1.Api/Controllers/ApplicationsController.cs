...
using InspirationStation1.Api.Infrastructure;
using InspirationStation1.Api.Models;

namespace InspirationStation1.Api.Controllers
{
    public class ApplicationsController : ApiController
    {
        private InspirationStationDataContext db = new InspirationStationDataContext();
